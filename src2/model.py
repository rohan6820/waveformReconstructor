...
python trainer.py --dataset other --cfg modifyConfig.yaml --root_path "C:\\Users\\anshu\\JupyterNotebooks\\Seismic-Inpainting\\dataset" --max_epochs 10 --output_dir output --img_size 28800 --base_lr 0.05 --batch_size 4
"""
...
class FinalPatchExpand_X4(nn.Module):
    def __init__(self, input_resolution, dim, dim_scale=4, norm_layer=nn.LayerNorm):
        ...
        self.expand = nn.Linear(dim, 120*dim, bias=False)
        # Ansh modify ends
        self.output_dim = dim
...
class WaveformReconstructor(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        Hello Preethi
        """
        super(WaveformReconstructor, self).__init__()
        self.num_classes = num_classes
